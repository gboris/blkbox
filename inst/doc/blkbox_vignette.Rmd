---
title: "Searching Data with blkbox"
...
blkbox incorperates a range of algorithms, however their demands for memory and run duration can be widely different, which can become a major consideration when dealing with larger data.
