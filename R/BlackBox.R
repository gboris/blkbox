...
#' @description This standard function will allow multiple machine learning algorithms to ulitilsed on the same data to determine which may be the most appropriate.
...
#' @param holdout.labels a character or numeric vector that contains the holdout or testing class indentifiers for the samples in the holdout data.frame.
